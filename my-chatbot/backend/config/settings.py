...
# -----------------------------------------------------------------------------
# Study gating (sequential sessions, 3 arms, 3 sessions/week, wall clock)
# -----------------------------------------------------------------------------
...
STUDY_PROFILE_CONTROL_MAX_SESSION_MINUTES = int(
    os.getenv("STUDY_PROFILE_CONTROL_MAX_SESSION_MINUTES", "20")
)
STUDY_PROFILE_CONTROL_DEFAULT_CHARACTER = os.getenv(
    "STUDY_PROFILE_CONTROL_DEFAULT_CHARACTER",
    "default",
)
